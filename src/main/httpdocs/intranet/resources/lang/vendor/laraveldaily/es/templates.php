...
return [
  ...
  'templates-menu_field_line-dont_use_ckeditor' => 'No usar CKEDITOR',
  'templates-menu_field_line-use_ckeditor' => 'Usar CKEDITOR',
  ...
  'templates-customView_index-list' => 'Listado',
  'templates-customView_index-welcome_custom_view' => 'Bienvenido',

  // templates-view_create
  'templates-view_create-add_new' => 'Crear nuevo',
  'templates-view_create-create' => 'Crear',

  // templates-view_create
  'templates-view_edit-edit' => 'Editar',
  'templates-view_edit-update' => 'Modificar',
  'templates-view_edit-cancel' => 'Cancelar',

  // templates-view_index
  'templates-view_index-add_new' => 'Crear nuevo',
  'templates-view_index-list' => 'Listado',
  'templates-view_index-edit' => 'Editar',
  'templates-view_index-delete' => 'Eliminar',
  'templates-view_index-delete_checked' => 'Eliminar seleccionados',
  'templates-view_index-confirm_deletion2' => '¿Desea eliminar?',  
  'templates-view_index-no_entries_found' => 'No se han econtrado resultados.',
  'templates-view_index-are_you_sure' => '¿Est&aacute; seguro?',
